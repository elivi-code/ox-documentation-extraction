...
> **See also:** [examples.md](examples.md) · [tokens.md](tokens.md) · [accessibility.md](accessibility.md) · [ProgressBar-usage.md](ProgressBar-usage.md) · [ProgressBar-figma.md](ProgressBar-figma.md)
...
|------|------|---------|-------------|
| `value` | `number` | `0` | Percentage of completed progress (0–100). When value reaches 100 the complete state is rendered (green fill, full track coverage). |
