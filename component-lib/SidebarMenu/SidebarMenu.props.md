...
<!-- STUB:GAP-002 source="Update @8x8/oxygen-sidebar-menu MCP source to formally type the `icon: ReactNode` prop on MenuItem" -->
...
| `link` | `string` | | URL associated with the sub-item. |
