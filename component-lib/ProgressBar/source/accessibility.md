...
> **See also:** [props.md](props.md) · [examples.md](examples.md) · [tokens.md](tokens.md) · [ProgressBar-usage.md](ProgressBar-usage.md) · [ProgressBar-figma.md](ProgressBar-figma.md)
...
| 1.4.3 Contrast (Minimum) | Review | Progress track and fill colors must meet text contrast requirements; see 1.4.11 for non-text UI components |
| 1.4.11 Non-text Contrast | Review | UI components must meet 3:1 against adjacent colors. Computed ratios vs. white page background: `--ui/ui01` (#ebeae1) ≈ 1.2:1 ✗ (track bg fails — flag to design); `--actions/action04` (#0056e0) ≈ 6.2:1 ✓; `--success/success01` (#127440) ≈ 5.8:1 ✓. Values derived from ProgressBar-figma.md token data; verify against rendered component. |
