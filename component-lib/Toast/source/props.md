...
_Shape derived from examples.md usage (`{ label: 'Download', onClick: () => handleDownload() }`). Confirm field names against @8x8/oxygen-toast source if additional fields are suspected._
