...
| Axis | Reason skipped |
|------|----------------|
| Stacking / grouping (`ToastStack`, group collapsed/expanded) | Conflict between Figma `Style` axis and Toast API ([Toast-figma.md:247](Toast-figma.md)) — needs resolution before editorial guidance. |
