...
<!-- STUB:GAP-010 source="Designer should add accessibility annotations to the Figma Modal component; engineering should confirm role=dialog and aria-modal=true are set on the dialog container element in the rendered DOM" -->
