...
<!-- STUB:GAP-006 source="Look up the default for enableMaxWidth in the @8x8/oxygen-calendar source and add to the Default column. Oxygen MCP get-component-props returns no default for this prop." -->
...
| `dayNumberFormat` | `string` | `'d'` | | date-fns format for day numbers |
